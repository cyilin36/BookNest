...
var (
	...
	ErrBookAlreadyInShelf   = NewError(http.StatusConflict, "book_already_in_bookshelf", "相同图书已在你的书架中")
	ErrBookAlreadyInLibrary = NewError(http.StatusConflict, "book_already_in_library", "相同图书已存在于公共图书馆")
